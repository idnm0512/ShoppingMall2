...
<body>
	<form id="item_review_form" action="/item/modifyReview" method="post" enctype="multipart/form-data">
		<table>
			<tr>
				<th>상품명</th>
			...
			<tr>
				<th>평점</th>
				<td>
					<select style="width: 40px; height: 30px;" name="grade">
						<option value="5" ${itemReviewInfo.grade == '5' ? 'selected="selected"' : '' }>5</option>
						<option value="4" ${itemReviewInfo.grade == '4' ? 'selected="selected"' : '' }>4</option>
						<option value="3" ${itemReviewInfo.grade == '3' ? 'selected="selected"' : '' }>3</option>
						<option value="2" ${itemReviewInfo.grade == '2' ? 'selected="selected"' : '' }>2</option>
						<option value="1" ${itemReviewInfo.grade == '1' ? 'selected="selected"' : '' }>1</option>
					</select>
				</td>
			</tr>
			<tr>
				<th>리뷰</th>
				<td>
					<textarea style="resize: none;" rows="10" cols="50" name="content">${itemReviewInfo.content }</textarea>
				</td>
			</tr>
			<tr>
				<th>이미지</th>
